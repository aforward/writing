...
![ChefDK Installer](/anunknown/assets/static/images/setting-up-chefdk/chefdk_installer.png?raw=true)

If you click on the `.pkg` that will open up the installer.  Follow the
instructions.

![ChefDK Install Prompts](/anunknown/assets/static/images/setting-up-chefdk/chefdk_install_prompt.png?raw=true)
